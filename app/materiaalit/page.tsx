  ...
  return (
    <div className='container mx-auto flex flex-col gap-8 px-6 lg:px-0'>
      <div className='flex flex-col'>
        ...
        <div
          className={`grid grid-cols-2 gap-4 bg-accent-800 bg-opacity-80 rounded-md shadow-md transition-all duration-200 ease-in-out ${
            filtersOpen
              ? "max-h-screen opacity-100 mt-4 pt-7 pb-10 px-8"
