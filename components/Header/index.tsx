...
export default function Example({
  ...
  return (
    <header
      className={`bg-gradient-to-r from-primary-600/90 to-primary-800/90 text-white backdrop-blur-lg w-full fixed z-30 shadow-lg lg:bg-opacity-90 duration-100 ${
